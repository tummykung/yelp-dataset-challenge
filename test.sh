...
TEST='test_graph'
TRAINING='smallnetflix_mm' # training set
VALIDATION='smallnetflix_mme' # validation set
K=100

#echo "(lambda = 0.01) Alternate least square (ALS) on "$TRAINING 
./als --matrixmarket=true --training=$TRAINING --validation=$VALIDATION --D=$K --maxiter=$MAXITER --ncpus=$THREADS --minval=1 --maxval=5 --quiet=1 --lambda=0.001

#echo "(lambda = 0.1) Alternate least square (ALS) on "$TRAINING 
./als --matrixmarket=true  --training=$TRAINING --validation=$VALIDATION --D=$K --maxiter=$MAXITER --ncpus=$THREADS --minval=1 --maxval=5 --quiet=1 --lambda=0.01
...
./sgd --matrixmarket=true --training=$TRAINING --validation=$VALIDATION --D=$K --maxiter=$MAXITER --ncpus=$THREADS --minval=1 --maxval=5 --quiet=1 --lambda=0.01


K=13
echo "Stochastic Gradient Descent (SGD) on "$TRAINING
./sgd --matrixmarket=true --training=$TRAINING --validation=$VALIDATION --D=$K --maxiter=$MAXITER --ncpus=$THREADS --minval=-5 --maxval=5 --quiet=1 --lambda=0.3


K=13
echo "lambda = 0.01; Stochastic Gradient Descent (SGD) on "$TRAINING
./sgd --matrixmarket=true --training=$TRAINING --validation=$VALIDATION --D=$K --maxiter=$MAXITER --ncpus=$THREADS --minval=-5 --maxval=5 --quiet=1 --lambda=0.5
...
#./sparse_als --matrixmarket=true --training=$TRAINING --validation=$VALIDATION --D=$K --maxiter=$MAXITER --ncpus=$THREADS --minval=1 --maxval=5 --quiet=1 --lambda=0.1

#./svd --matrixmarket=true --training=$TRAINING --validation=$VALIDATION --D=$K --maxiter=$MAXITER --ncpus=$THREADS --minval=1 --maxval=5 --quiet=1 --lambda=0.1
