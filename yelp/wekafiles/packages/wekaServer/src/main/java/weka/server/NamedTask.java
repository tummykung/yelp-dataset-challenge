...
/**
 * Extension of the Task interface for tasks with a
 * name/ID. Also adds some methods for memory management.
 * 
...
public interface NamedTask extends Task {
  ...
  /**
   * Stop the currently running task (if possible). Does nothing if
